Determine the best supervised machine learning model to predict credit risk: **NaiveRandomOverSampler, SMOTE, SMOTEENN, BalancedRandomForestClassifier and EasyEnsembleClassifier.**
